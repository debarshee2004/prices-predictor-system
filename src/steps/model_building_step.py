...
# Define the artifact config separately
SklearnPipelineConfig = ArtifactConfig(name="sklearn_pipeline", is_model_artifact=True)


@step(enable_cache=False, experiment_tracker=experiment_tracker.name, model=model)
def model_building_step(
    X_train: pd.DataFrame, y_train: pd.Series
) -> typing.Annotated[Pipeline, SklearnPipelineConfig]:
    """
